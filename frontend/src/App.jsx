...
function AppContent() {
  ...
  const addLog = (nuevoLog) => {
    setLog(prev => [nuevoLog, ...prev]);
  };
  ...
  const cerrarModal = () => setModalRegisterAbierto(false);
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflow: 'auto', position: 'relative', zIndex: 1 }}>
          ...
          {pantalla === 'admin' && (
            <AdminPage 
              menuItems={[]}
              onSaveMenu={(menu) => console.log("Guardar menú:", menu)}
              log={log}
              addLog={addLog}
